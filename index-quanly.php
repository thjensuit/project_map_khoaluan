		...
		<div class="slide"> <!-- begin slide -->
			<div class="row">
				<div class="col-sm-12" style="padding-left: 0px;padding-right: 0px">
					<img id="bia" src="img/banner.jpg" style=" width:100%;height:125px">
				</div>
			</div>
		</div>  <!-- End .slide -->
		...
		<div class="menu row" style="background:/*#026A52 */	 /*#ff8533*/#1373af ; "><!-- Begin menu -->
			<div class="col-sm-6 col-sm-offset-4">
				<ul>
					...
					<li><a href="http://localhost/khoaluan/quanly/dashboard.php?username1=<?php echo $tentaikhoan ?>">Quản Lý</a></li>
				</ul>
			</div>
		</div><!-- End menu -->
				...
				<div class="col-sm-12" style="padding-bottom:25px;border:1px solid #f5f5f0" >
					...
					<div class="col-sm-12" style="padding-bottom:25px;border:1px solid #f5f5f0">
						...
						<div class="row">
							...
							<div class="col-sm-10 col-sm-offset-1"><h3 style="color:#cc3300; font-weight: bold;" >Mức đánh giá chất lượng môi trường không khí theo WQI</h3></div>
							<div class="col-sm-8 col-sm-offset-2">
								<table class="table table-bordered table-str">
									<thead>
										<tr class="active">
