...
<body>
	<?php
	 ...
	 ?>
	<form action="http://localhost/khoaluan/wqi/report/test_main.php?username=<?php echo $tentaikhoan ?>&filename=<?php if(isset($_GET['filename'])){
            echo $_GET['filename'];
            } ?>" method="post">
				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						<div class="modal-header">
							<div class="row">
								<div class="col-md-12">
									<a  class="close" href="http://localhost/khoaluan/wqi/dashboard.php?username=<?php echo $tentaikhoan ?>">&times;</a>
						...
						<div class="modal-footer">
							...
							<a class="btn btn-default" href="http://localhost/khoaluan/wqi/dashboard.php?username=<?php echo $tentaikhoan ?>"> Đóng</a>
						</div> <!-- end footer -->
