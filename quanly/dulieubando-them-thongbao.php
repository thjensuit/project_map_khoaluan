		...
		if(isset($_FILES['filebando'])){
			...
			if($uploaded==true){
				...
				if($result_inserttenhinh== true){
					...
					if($result==true){
						echo "<h3>Thêm dữ liệu thành công, bấm vào <a href=\"http://khoa-luan.local/quanly/dashboard.php?username=&active=dulieubando\"> đây </a> để quay lại</h3>";
					}

				}else{
					echo "<h3>Thêm dữ liệu thất bại, bấm vào <a href=\"http://khoa-luan.local/quanly/dulieubando-them.php?username=admin\"> đây </a> để thêm lại</h3>";
				}
			}
		}//-> end file ban do
	}
