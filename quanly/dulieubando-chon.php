<?php
	if(isset($_GET['filename'])){
		...
		if($sodong > 2 ){
			echo "<h3>Chọn dữ liệu thất bại, bấm vào <a href=\"http://khoa-luan.local/quanly/dashboard.php?username=&active=dulieubando\"> đây </a> để quay lại</h3>";
		}else{
			...
			while($row = pg_fetch_array($result)){
				...
				if($resut_insert==true){
					echo "<h3>Chọn dữ liệu thành công, bấm vào <a href=\"http://khoa-luan.local/quanly/dashboard.php?username=&active=dulieubando\"> đây </a> để quay lại</h3>";
				}
			}
			}
		}
