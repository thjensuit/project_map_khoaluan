							...
							while($row = pg_fetch_array($result)){
								...
								<tr>
									...
									<td><?php echo $row['thoigian'];?></td>
										...
										<td>
										<a class="btn btn-warning" style="color:white; margin-left: 50px" name="xoa" href="http://khoa-luan.local/quanly/dulieuwqi-main.php?username=admin&tentaikhoan=<?php echo $row[1] ?>&tenfile=<?php echo $row[2] ?>"> Xóa</a>
