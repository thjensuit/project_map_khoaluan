...
if($result== true){
	echo "<h3>Bạn đã xóa dữ liệu thành công, bấm vào"."<a href=\"http://localhost/khoaluan/quanly/dashboard.php?username=admin&active=dulieuaqi\"> đây </a>". "để quay lại !</h3>";
}
