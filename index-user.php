		...
		<div class="slide"> <!-- begin slide -->
			<div class="row">
				<div class="col-sm-12" style="padding-left: 0px;padding-right: 0px">
					<img id="bia" src="img/banner.jpg" style=" width:100%;height:150px">
				</div>
			</div>
		</div>  <!-- End .slide -->
		...
		<div class="menu row" style="background:/*#026A52 */	 /*#ff8533*/#1373af ; "><!-- Begin menu -->
			<div class="col-sm-6 col-sm-offset-3">
				<ul>
					...
					<li><a href="wqi/dashboard.php?username=<?php echo $tentaikhoan?>">Tính toán chỉ số WQI</a></li>
					<li><a href="aqi/dashboard-aqi.php?username=<?php echo $tentaikhoan?>">Tính toán chỉ số AQI</a></li>
				</ul>
			</div>
		</div><!-- End menu -->

		<div id="content" style="margin-top: 15px;border:1px solid #f5f5f0">
